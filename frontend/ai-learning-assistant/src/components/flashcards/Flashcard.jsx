  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="absolute inset-0 w-full h-full bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl"
          style={{
        ...
        >
          ...
          {/* Flip Indicator */}
          <div className="flex items-center justify-center gap-2 text-xs text-slate-400 font-medium pb-4">
        ...
        <div
          className="absolute inset-0 w-full h-full bg-linear-to-br from-emerald-500 to-teal-500 rounded-2xl"
          style={{
            backfaceVisibility: 'hidden',
            WebkitBackfaceVisibility: 'hidden',
        ...
        >
            ...
            <button
              ...
              className={`w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-200
                ${flashcard.isStarred
                  ...
                  : 'bg-white/20 backdrop-blur-sm text-white/70 hover:bg-white/30 hover:text-white'
                }`}
            >
              <Star
                className="w-4 h-4"
          ...
          {/* Flip Indicator */}
          <div className="flex items-center justify-center gap-2 text-xs text-white/70 font-medium pb-4">
            <RotateCcw className="w-3.5 h-3.5" strokeWidth={2} />
